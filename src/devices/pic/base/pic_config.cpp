...
const Pic::Config::Data Pic::Config::DATA[] = {
  ...
  { { "WDT",  I18N_NOOP("Watchdog timer") }, Toggle, {
    { "On_run",   I18N_NOOP("Enabled in run - Disabled in sleep") },
    { "Software", I18N_NOOP("Controlled by SWDTEN bit") }, { 0, 0 } } },
  ...
  { { "FOSC",  I18N_NOOP("Oscillator") }, Fixed,  {
    ...
    { "EC_CLKOUT_HP", I18N_NOOP("External clock with CLKOUT, high power") },
    { "EC_CLKOUT_MP", I18N_NOOP("External clock with CLKOUT, medium power") },
    { "EC_CLKOUT_LP", I18N_NOOP("External clock with CLKOUT, low power") },
    { "EC_HP", I18N_NOOP("External clock, high power") },
    { "EC_MP", I18N_NOOP("External clock, medium power") },
    { "EC_LP", I18N_NOOP("External clock, low power") },

    { "HS_HP", I18N_NOOP("HS oscillator, high power") },
    { "HS_MP", I18N_NOOP("HS oscillator, medium power") },

    { 0, 0 } } },

    { { "CLKOUTEN", I18N_NOOP("Clock out") }, Toggle, { { 0, 0 } } },
  ...
  { { "BODEN", I18N_NOOP("Brown-out detect")       }, Toggle, {
    { "On_run",   I18N_NOOP("Enabled in run - Disabled in sleep") },
    { "Hardware", I18N_NOOP("Hardware only")                      },
    { "Software", I18N_NOOP("Controlled by SBODEN bit")           }, { 0, 0 } } },
  ...
  { { "PLLEN", I18N_NOOP("PLL")                          }, Toggle, { { 0, 0 } } },
  ...
  { { "PM",    I18N_NOOP("Processor mode") }, Fixed, {
    ...
    { 0, 0 } } },
  { { "VCAP", I18N_NOOP("Voltage Regulator Capacitor") }, Pin, {
    { "Off", I18N_NOOP("Off") },
    { 0, 0 } } },
  ...
  { { "T3CMX", I18N_NOOP("Timer3 Clock Input mux") }, Pin, { { 0, 0 } } },
  { { "P2BMX", I18N_NOOP("P2B Input mux") }, Pin, { { 0, 0 } } },
  ...
  //18K specific
  { { "PLL4EN", I18N_NOOP("4x PLL enable") }, Toggle, { { 0, 0 } } },
  { { "PRICLKEN", I18N_NOOP("Primary clock enable") }, Toggle, { { 0, 0 } } },
  { { "HFOFST", I18N_NOOP("HFINTOSC fast start") }, Toggle, { { 0, 0 } } },
  ...
  { { "FNOSC", I18N_NOOP("Initial oscillator source") }, Fixed, {
    ...
    { "INTRC_F_16",  I18N_NOOP("Internal fast RC oscillator with divide-by-16") },
