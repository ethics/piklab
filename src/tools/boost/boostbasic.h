...
{
public:
  virtual QString execName() const { return "boostbasic.pic16.exe"; }
};

class CompilerBasic18 : public CompilerBasic
{
public:
  virtual QString execName() const { return "boostbasic.pic18.exe"; }
};
...
private:
  ...
  virtual bool supportedArchitecture(Pic::Architecture architecture) const { return ( architecture==Pic::Architecture::MidRange || architecture==Pic::Architecture::EMidRange); }
};
