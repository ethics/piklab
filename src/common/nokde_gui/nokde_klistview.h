...
public:
 ...
 /**
   ...
   * @deprecated
   */
  QPtrList<Q3ListViewItem> selectedItems() const;
   ...
   * @since 3.4
   */
  QPtrList<Q3ListViewItem> selectedItems(bool includeHiddenItems) const; // ### BIC: KDE 4: use an implicitly shared class! (QValutList?) and merge with above, default to true
...
signals:
   ...
   */
  void moved(QPtrList<Q3ListViewItem> &items, QPtrList<Q3ListViewItem> &afterFirst, QPtrList<Q3ListViewItem> &afterNow);
   ...
   * contextMenu (KListView*, Q3ListViewItem*, const QPoint&) to correctly
...
public:
   ...
   * don't mix KListViewItem (or subclasses) with Q3ListViewItem
   * (or subclasses).
   */
