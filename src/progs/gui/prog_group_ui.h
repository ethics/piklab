...
//----------------------------------------------------------------------------
class ButtonContainer : public Container::Button
{
Q_OBJECT
public:
...
//----------------------------------------------------------------------------
class AdvancedDialog : public PageDialog
{
Q_OBJECT
public:
...
protected:
  Base &_base;
  Container::Grid *_programmerContainer, *_calibrationContainer;
...
private:
  QLabel *_firmwareLabel, *_voltages[Device::VoltageType::Nb_Types];
};
